...
#Exporting the results to csv file
write.csv(df_lasso_results, file = "df_lasso_results_t_Markov_X.csv", row.names = FALSE)
...
#Exporting the results to csv file
write.csv(df_SCAD_results, file = "df_SCAD_results_t_Markov_X.csv", row.names = FALSE)
